...
import {
    AfricarareNFT, AfricarareNFT__factory, AfricarareNFTFactory__factory,
    AfricarareNFTFactory, AfricarareNFTMarketplace__factory, AfricarareNFTMarketplace,
...
describe("Africarare Marketplace", () => {
    ...
    before(async () => {
        ...
        payableToken = await Token.deploy('Africarare Token', 'KPT');
        ...
        const tx = await factory.connect(creator).createNFTCollection("Africarare Collection", "AFRICARARE", BigNumber.from(10 * 100), royaltyRecipient);
        ...
        nft = new ethers.Contract(collectionAddress, AfricarareNFT__factory.abi, creator) as AfricarareNFT;
